 ...
 * This file demonstrates how to integrate Apexxeno with a web frontend
 */

// For React/Vue/Angular applications
export class ApexxenoClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ApexxenoClient(provider, contractAddress);
